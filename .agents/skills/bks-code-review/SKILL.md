...
| **Checklist review** | Pre-landing, `/bks-ship` pipeline, security audit | `references/checklist-workflow.md` |
...
**Process:**
1. Invoke `/bks-scout` with edge-case-focused prompt
...
|------------|-----------|---------|
| `/bks-code-review codebase` | `references/codebase-scan-workflow.md` | Scan & analyze the codebase |
| `/bks-code-review codebase parallel` | `references/parallel-review-workflow.md` | Ultrathink edge cases, then parallel verify |
