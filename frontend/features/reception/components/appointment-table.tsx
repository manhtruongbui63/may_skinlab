/**
 * Appointment Table Component (Adapted for Scheduled Visits)
 * @module AppointmentTable
 */
'use client'
...
export function AppointmentTable({ visits, onCancel, onDelete, onEdit }: AppointmentTableProps) {
