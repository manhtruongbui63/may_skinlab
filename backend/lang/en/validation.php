...
return [
    ...
    */
    ...
    'password_regex' => 'The :attribute must contain at least one uppercase letter, one lowercase letter, one number, and one special character.',
    'upload_error_type' => 'Invalid upload type.',
    'password_min_length' => 'The password must contain at least 6 characters.',
    'password_max_length' => 'The password must not exceed 32 characters.',
    ...
    */
    ...
    'custom' => [
        ...
        'appointment_time' => [
            'slot' => 'Appointment time must be on a 30-minute boundary (e.g., 09:00 or 09:30).',
        ],
        'customer_id' => [
            'active' => 'The selected customer is not active.',
        ],
    ],
