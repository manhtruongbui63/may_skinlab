...
return [
    ...
    'password_min_length' => 'パスワードは6文字以上にする必要があります。',
    'password_max_length' => 'パスワードは32文字以下にする必要があります。',
    'password_digit' => 'パスワードには少なくとも1つの数字を含める必要があります。',
    'password_lowercase' => 'パスワードには少なくとも1つの小文字を含める必要があります。',
    'password_uppercase' => 'パスワードには少なくとも1つの大文字を含める必要があります。',
    'password_special' => 'パスワードには少なくとも1つの記号を含める必要があります。',
    'custom' => [
        'phone' => [
