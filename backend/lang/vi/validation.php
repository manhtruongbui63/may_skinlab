...
return [
    ...
    'password_lowercase' => 'Mật khẩu phải chứa ít nhất một chữ cái viết thường.',
    ...
    'custom' => [
        'phone' => [
            'unique' => 'Số điện thoại đã tồn tại trên hệ thống.',
        ],
        'appointment_time' => [
            'slot' => 'Giờ hẹn phải chia hết cho 30 phút (ví dụ: 09:00 hoặc 09:30).',
        ],
        'customer_id' => [
            'active' => 'Khách hàng được chọn không ở trạng thái hoạt động.',
        ],
    ],
];
